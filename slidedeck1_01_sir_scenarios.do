...
** Cumulative Infected 
    gen infect_new = I
    replace infect_new  = IB if days >= 7
    replace infect_new  = IC if days >= 14
    replace infect_new  = ID if days >= 21
    replace infect_new  = IE if days >= 28
